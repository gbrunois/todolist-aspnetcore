...
Build a Docker image named angularmovie-aspnetcore
#>
...
$imageName="angularmovie-aspnetcore"
$projectName="angularmovieaspnetcore"
$serviceName="angularmovie-aspnetcore"
